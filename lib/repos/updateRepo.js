...
export async function getPendingMigrations() {
  try {
    // Use the migration runner's scanning function (server-side only)
    const { getPendingMigrations: scanPending } = require('@/scripts/run-migrations');
    const result = await scanPending();
