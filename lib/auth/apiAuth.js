    ...
    if (isDev) {
      ...
      if (userId) {
        ...
        const devFallbackUsers = {
          'user_superadmin': { id: 'user_superadmin', name: 'Super Admin', email: 'admin@indusia.ai', role_id: 'role_superadmin', status: 'active' },
          'user_manager': { id: 'user_manager', name: 'Manager User', email: 'manager@indusia.ai', role_id: 'role_manager', status: 'active' },
          'user_engineer': { id: 'user_engineer', name: 'Engineer User', email: 'engineer@indusia.ai', role_id: 'role_engineer', status: 'active' },
          'user_operator': { id: 'user_operator', name: 'Operator User', email: 'operator@indusia.ai', role_id: 'role_operator', status: 'active' },
        }
        
        if (devFallbackUsers[userId]) {
          console.log('[Auth] Using dev fallback user:', userId)
