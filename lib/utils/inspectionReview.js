 ...
 *
 * Backend (Auto Inspect Edge) returns bbox coordinates at 1:1 scale
 * with the real capture image (5472x3648). No coordinate remapping needed.
 *
 ...
 * @returns {{ x: number, y: number }} Scale factors (always 1:1)
 */
