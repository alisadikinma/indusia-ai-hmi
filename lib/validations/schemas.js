...
export const createOverrideSchema = z.object({
  ...
  override_type: z.string().optional(), // Alias for defect_type from LiveView
  ...
  section_id: z.string().optional(), // Optional - skip validation for operators on active line
  line_id: z.string().optional(),
  customer_id: z.string().optional(),
  image_url: z.string().url().optional().or(z.literal('')),
  local_image_path: z.string().optional(),
  local_image_paths: z.string().optional() // JSON string
})
